...
public class Vector<E> extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, Serializable {
     ...
     * @since 1.2
     */
    // (匹配则移除)移除当前向量表中所有与给定容器中的元素匹配的元素
     ...
     * @since 1.2
     */
    // (不匹配则移除)移除当前向量表中所有与给定容器中的元素不匹配的元素
     ...
     */
    // 移除当前向量表[fromIndex,toIndex]之间的元素
     ...
     */
    // 返回指定元素的正序索引，从index索引处开始正向查找(正序查找首个匹配的元素)
     ...
     */
    // 返回指定元素的逆序索引，从index索引处开始逆向查找(逆序查找首个匹配的元素)
     ...
     */
    // 返回当前向量表的一个增强的迭代器，且设定下一个待遍历元素为索引0处的元素
     ...
     */
    // 返回当前向量表的一个增强的迭代器，且设定下一个待遍历元素为索引index处的元素
     ...
     */
    // 重新设置向量表的容量，如果新容量小于元素数量，则会移除超出新容量的元素
    ...
    private int newCapacity(int minCapacity) {
        ...
        int newCapacity = oldCapacity + ((capacityIncrement>0) ? capacityIncrement : oldCapacity);  // 预期新容量（默认增加一倍）
